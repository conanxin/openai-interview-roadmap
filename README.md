# OpenAI / AI Lab Interview Roadmap

A Chinese AI Lab interview training system that combines LLM learning resources, Mini GPT practice, interview drills, progress tracking, portfolio preparation, and public learning logs.

[![Live Demo](https://img.shields.io/badge/Live%20Demo-GitHub%20Pages-0d7e76)](https://conanxin.github.io/openai-interview-roadmap/)
[![Mini GPT Repo](https://img.shields.io/badge/Mini%20GPT-PyTorch%20Project-f1a72e)](https://github.com/conanxin/mini-gpt-from-scratch)
![React](https://img.shields.io/badge/React-19-149eca)
![Vite](https://img.shields.io/badge/Vite-8-646cff)
![Static Site](https://img.shields.io/badge/Static%20Site-GitHub%20Pages-333333)

这是一个个人学习型静态网页项目，当前定位是“OpenAI / AI Lab 面试训练系统与公开学习作品集”。页面基于 Alisa Liu 的 OpenAI / AI Lab 求职经验和公开学习资源，整理面向顶级 AI Lab / GenAI Engineer 面试的中文学习系统、Mini GPT 实践项目、训练工具、复盘导出和作品集生成路径。

## Preview

![Homepage showcase](docs/screenshots/homepage.png)

| Dashboard | 12-week Course | Portfolio Toolkit |
| --- | --- | --- |
| ![Dashboard](docs/screenshots/dashboard.png) | ![Course](docs/screenshots/course.png) | ![Portfolio](docs/screenshots/portfolio.png) |

## Links

- Live Demo: https://conanxin.github.io/openai-interview-roadmap/
- Roadmap Repo: https://github.com/conanxin/openai-interview-roadmap
- Mini GPT Repo: https://github.com/conanxin/mini-gpt-from-scratch
- Mini GPT Project Page: https://conanxin.github.io/openai-interview-roadmap/#/projects/mini-gpt

## 功能总览

| Module | What it does |
| --- | --- |
| In-site Chinese Learning Pages | 中文学习资源页和深度讲义 |
| 12-week Course Path | 12 周 AI Lab 面试课程路径 |
| Mini GPT Project Roadmap | 从零实现 Mini GPT 的项目路线图 |
| Interview Bank | 54 道 AI Lab 面试题 |
| Mock Interview | 结构化模拟面试模式 |
| Review & Export | 错题复盘和 Markdown 导出 |
| Portfolio Toolkit | 简历、项目 pitch、行为故事工具 |
| Learning Log | 公开学习日志和周报模板 |
...
→ provides learning path, course, dashboard, interview bank, portfolio toolkit

mini-gpt-from-scratch
→ provides runnable PyTorch implementation of tokenizer, attention,
  Transformer block, training, generation, checkpointing

Together:
learning system + runnable code portfolio
```

## 适合谁使用？

- Research Engineer candidates
- GenAI Application Engineer candidates
- AI Product / Tooling Engineer candidates
- Engineers learning LLM fundamentals
- People building a public learning portfolio
...
`deploy:manual` 会构建 `dist/`，进入 `dist/` 内部初始化临时 `gh-pages` 分支，并将构建产物 force push 到远端 `gh-pages` 分支根目录。
...
V8C 把 GitHub README 升级为更适合公开作品集展示的项目首页。

新增能力：

- 新增 README 顶部英文定位、Live Demo / Mini GPT / React / Vite / GitHub Pages badges。
- 新增 `docs/screenshots/homepage.png` 首页截图，以及 Dashboard、Course、Portfolio 辅助截图。
- 新增功能总览表、Site Map、双项目关系图、适合人群和 Current Version 摘要。
- 优化本地运行、构建、lint 和 `deploy:manual` 部署说明。
- 新增 `docs/screenshots/README.md`，记录截图用途和来源。
